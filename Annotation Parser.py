...
def parse_gt_output(manifest_path, job_name):
    ...
    with filesys.open(manifest_path) as fin:
        ...
        df_bbox = pd.DataFrame(
            annot_list,
            columns=["img_file","category","box_left","box_top","box_height","box_width","img_width","img_height",],)
